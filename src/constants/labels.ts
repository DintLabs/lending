export const LABELS = {
  ...
  APP_TITLE: "Dint Lending",
  CONNECT_BUTTON: "Connect",
  WALLET_TOOLTIP: "Wallet public key",
  WALLET_BALANCE: "Wallet balance",
  OYSTER_BALANCE: "Dint balance",
  ...
  NOT_ENOUGH_MARGIN_MESSAGE:
    "Not enough buying power in dint to make this trade at this leverage.",
  ...
  NO_DEPOSIT_MESSAGE:
    "You need to deposit coin of this type into dint before trading with it on margin.",
  NO_ENOUGH_COLLATERAL_MESSAGE:
    "The Collateral is greater than your Dint Balance. The difference will be deposited first.",
